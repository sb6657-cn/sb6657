...
export const MemeCategory = [
    ...
    { path: '/15warriorsDonk', text: '布雷德15勇士', icon: donk, keepColor: true },
    { path: '/matchLib', text: '赛事烂梗库', icon: cs2_icon },
    { path: '/matchPrediction', text: '赛事竞猜', icon: cs2_icon },
    { path: '/dejaVuNiko', text: '超级逮虾户战报', icon: deja_vu_niko, keepColor: true },
    { path: '/stale', text: '烂度热榜', icon: stale_icon, keepColor: true },
    { path: '/arena', text: '烂梗擂台', icon: arena_icon, keepColor: true },
    { path: '/lifecycle', text: '梗生命周期', icon: lifecycle_icon, keepColor: true },
    { path: '/hotwall', text: '实时热度墙', icon: hotwall_icon, keepColor: true },
];
